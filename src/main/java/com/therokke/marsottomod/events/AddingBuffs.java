...
public class AddingBuffs {
    ...
    @SubscribeEvent
    public void addInstaHealth(PlayerInventory e){
        if(e.hasItemStack(new ItemStack(RegistryHandler.INSTANT_HEALTH_ITEM.get()))){
            Power_Wand.add(Effects.INSTANT_HEALTH);
        }
    }
